            ...
            <tbody>
                <?php foreach ($kontakty as $kontakt): ?>
                    <tr>
                        ...
                        <td><a href="/?action=showc&idco=<?php echo $kontakt['kontakt_id']; ?>" title="Klienci pracownika"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
